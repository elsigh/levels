...
var filestocopy = [{
    ...
    'config/android/res/drawable/icon_notification.png':
    'platforms/android/res/drawable/icon_notification.png'
}, {
    'config/android/res/drawable-ldpi/icon_notification.png':
    'platforms/android/res/drawable-ldpi/icon_notification.png'
}, {
    'config/android/res/drawable-mdpi/icon_notification.png':
    'platforms/android/res/drawable-mdpi/icon_notification.png'
}, {
    'config/android/res/drawable-hdpi/icon_notification.png':
    'platforms/android/res/drawable-hdpi/icon_notification.png'
}, {
    'config/android/res/drawable-xhdpi/icon_notification.png':
    'platforms/android/res/drawable-xhdpi/icon_notification.png'
}, {
    'config/android/res/drawable-xxhdpi/icon_notification.png':
    'platforms/android/res/drawable-xxhdpi/icon_notification.png'
}, {
    'config/android/res/drawable-xxxhdpi/icon_notification.png':
